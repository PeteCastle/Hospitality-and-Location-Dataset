...
class TripadvisorRestaurant(TripadvisorWrapper):
    def __init__(self, NUM_PAGES=1, locations_file = "raw_data/locations_url.json"):
        super().__init__(NUM_PAGES, locations_file)
        return
